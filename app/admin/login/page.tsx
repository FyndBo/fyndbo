      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-800 font-medium px-6 py-3 rounded-xl transition-all mb-4 disabled:opacity-50"
          >
          ...
          <form onSubmit={handleCredentialsLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                disabled={loading}
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
              />
            </div>
            <div>
